...
//  25. Вывести в консоль тип данных item_7 в виде ——  “item_7 == ” 
//  item_7,  “item_7_type == ”  item_7_type ——  
...
const checkAge_2 = function(age){
    ...
    let message = console.log("Error! The age type should be a number!"); 
       return message;
    }
...
const checkAge_3 = function(age){
    if(typeof age !== "number" && !Number.isNaN(+age) == false){
    let message = console.log("Error! The age type should be a number!"); 
       return message;
    }
    else{
